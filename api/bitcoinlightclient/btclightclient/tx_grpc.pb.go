...
const (
	Msg_UpdateParams_FullMethodName  = "/bitcoinlightclient.btclightclient.Msg/UpdateParams"
	Msg_InsertHeaders_FullMethodName = "/bitcoinlightclient.btclightclient.Msg/InsertHeaders"
)
...
func (c *msgClient) InsertHeaders(ctx context.Context, in *MsgInsertHeaders, opts ...grpc.CallOption) (*MsgInsertHeadersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_InsertHeaders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) InsertHeaders(context.Context, *MsgInsertHeaders) (*MsgInsertHeadersResponse, error) {
...
func _Msg_InsertHeaders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_InsertHeaders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
